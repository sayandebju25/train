...
exports.addTrain = [
  authMiddleware("admin"), // Middleware to ensure only admins can add trains
  async (req, res) => {
    let trains = req.body;
  ...
  exports.updateTrainSeats = [
    authMiddleware("admin"), // Middleware to ensure only admins can update train seats
    async (req, res) => {
